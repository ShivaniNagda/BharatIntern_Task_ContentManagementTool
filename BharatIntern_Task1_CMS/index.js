...
function submitForm() {
  ...
  var contact = document.getElementById('contact').value;
    ...
    +
       "<div class='card-body bg-light ' style='font-size:1rem; margin=2px;' >" +
       
      "<h6 class='card-title' > <b>Name  : </b>" + name + "</h6>" +

      "<h6 class='card-title'> <b>E-mail : </b>" + mail + "</h6>" +
      "<h6 class='card-title'> <b>Contact : </b>" + contact + "</h6>" +
    ...
    "</div>" +
    "<div class='card-body bg-light ' style='font-size:1rem;' >" +
